import { memoize, pathGet, pathRemove, pathSet } from '../dist/utils/memoize.js'
...
describe('path utils', () => {
  ...
  it('removes with a multiple items in the path', () => {
    ...
    equal(pathGet(a, [key, key2]), undefined)
  })
